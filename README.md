...
>
> **GFTW token and Migration are live on BNB Smart Chain mainnet.** Staking and vesting contracts
...
> | | |
> |---|---|
> | Deployed | **Yes — GFTW token on BSC mainnet `0xD3D2c5Ab093a6aBa53EAbEA005D4226113C837F6`** · **Migration `deployed`** |
> | Treasury Safe | `0xE26D92b34B8EB79d9B415605aAa46de47066a38B` (2-of-3, owners `0x5e3c…9818`, `0x917E…0605`, `0x3EF7…08B`, salt `44384351`) |
> | Pair WBNB/GFTW | `0x867cEb98260eF05Adce3A021FC66b90E7a276293` `Pancake V2` |
